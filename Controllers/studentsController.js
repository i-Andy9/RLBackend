...
const addStudents = async (req, res) => {
  try {
    ...
    return res.json({
      ...
      status: "creado",
      students: {
        name: studentsExist.name,
        lastName: studentsExist.lastName,
        rut: studentsExist.rut,
        age: studentsExist.age,
        classroom: studentsExist.classroom,
        gender: studentsExist.gender,
        family: studentsExist.family,
      },
    });
  } catch (error) {
